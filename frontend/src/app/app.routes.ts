...
export const routes: Routes = [
    ...
    { path: 'doctors', component: Doctors, title: 'Lekarze', canMatch: [roleGuard], data: { roles: [0], icon: 'medical_services' } },
    { path: 'visits', component: Visits, title: 'Wizyty', canMatch: [roleGuard], data: { roles: [0, 2], icon: 'event' } },
